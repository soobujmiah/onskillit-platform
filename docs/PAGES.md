...
| USER-TRAINING | Training calendar | /learn/training | Student | See sessions and attendance | learn | TMS | user | own TrainingParticipation | noindex | listing | USER-TRAINING | P0 | PHASE-07 | NOT STARTED | Batch, Session, TrainingParticipation, Attendance |
...
- Lesson player → identity, active LearningAccess entitlement (staff-granted or linked to admitted enrollment), stable course edition, private media, progress API.
