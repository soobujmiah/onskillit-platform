...
| Learning | LearningAccess links User to CourseEdition; TrainingParticipation links User to Batch; later Enrollment links the admitted offer/access; LessonCompletion; Assessment; Submission; Grade; Certificate | Unique active enrollment, immutable grade/issuance history |
| Training | Program 1:N Batch 1:N TrainingSession; TrainerAssignment; Attendance; Result | Capacity lock, time-zone aware schedule, attendance by session/participation |
